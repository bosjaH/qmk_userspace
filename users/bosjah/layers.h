...
#define __LOWER_60_ROW5_____________________    _______,          _______, _______, KC_SPC,  KC_SPC,  KC_SPC,  KC_PGDN, M_WRDL,  M_WRDR,  _______, _______,          _______
...
#define __RAISE_60_ROW3_____________________    _______, _______, _______, _______, _______, M_TM,    KC_CALC, KC_HOME, KC_UP,   KC_END,  _______, _______, _______, _______
#define __RAISE_60_ROW4_____________________    _______, _______, _______, _______, _______, _______, KC_PGUP, KC_LEFT, KC_DOWN, KC_RIGHT,_______, KC_NUHS,          FN_ADJUST
#define __RAISE_60_ROW5_____________________    _______,          _______, _______, KC_SPC,  KC_SPC,  KC_SPC,  KC_PGDN, M_WRDL,  M_WRDR,  _______, _______,          _______
