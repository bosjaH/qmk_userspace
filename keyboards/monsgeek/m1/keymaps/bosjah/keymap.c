...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [L_LOWER] = { ENCODER_CCW_CW(RM_NEXT, RM_PREV) },
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_HRM_TRAINING] = WRAPPER_ansi(
        ...
        __BASE_60_ROW5_DM___________________, _______, _______,
        __BASE_75_ROW6_DM___________________),
#endif
