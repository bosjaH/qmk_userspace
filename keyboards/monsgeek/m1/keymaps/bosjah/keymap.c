...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_SPACE_FN] = LAYOUT_ansi(
        ...
        _______, _______, _______, C_EURO,  _______, MS_BTN4, MS_BTN5, KC_HOME, KC_UP,   KC_END,  _______, _______, _______, _______,          _______,
    ...
    [L_EXTENDED] = LAYOUT_ansi(
        ...
        C_LCKEXT,MS_BTN4, MS_WHLU, MS_BTN5, _______, M_TM,    KC_CALC, KC_HOME, KC_UP,   KC_END,  _______, _______, _______, _______,          RM_HUED,
        _______, MS_WHLL, MS_WHLD, MS_WHLR, _______, _______, KC_PGUP, KC_LEFT, KC_DOWN, KC_RIGHT,_______, KC_NUHS,          FN_CONFIG,        RM_SATU,
