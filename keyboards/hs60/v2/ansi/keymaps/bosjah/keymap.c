...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------|
     * |Ctrl|Gui |Alt |        SpaceFN         |Alt |Gui |F13 |Ctrl|
     * `-----------------------------------------------------------'
     */
  [L_DEFAULT] = LAYOUT_60_ansi(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,                            FN_SPACE_FN,                           KC_RALT,  KC_RGUI,  KC_F13,   KC_RCTL   \
    ),
  ...
  [L_DEFAULT_EURKEY] = LAYOUT_60_ansi(
        KC_ESC,   KC_1,     KC_2,     KC_3,    KC_4,     KC_5,     KC_6,     KC_7,    KC_8,  KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,  \
        KC_TAB,   KC_Q,     KC_W,     KC_E,    KC_R,     KC_T,     KC_Y,     KC_U,    KC_I,  KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,  \
        FN_EXT,   KC_A,     KC_S,     KC_D,    KC_F,     KC_G,     KC_H,     KC_J,    KC_K,  KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,   \
        KC_LSFT,  KC_Z,     KC_X,    KC_C,     KC_V,     KC_B,     KC_N,     KC_M,  KC_COMM, KC_DOT,   KC_SLSH,                      KC_RSFT,  \
        KC_LCTL,  KC_LGUI,  KC_LALT,                            FN_SPACE_FN,                   FN_EURKEY_ALTGR,  KC_RGUI,  KC_F13,   KC_RCTL   \
    ),
  ...
  [L_SPACE_FN] = LAYOUT_60_ansi(
        ...
        ______,   ______,   ______,   M_EUR,    ______,   MS_BTN4,  MS_BTN5,  KC_HOME,  KC_UP,    KC_END,   ______,   M_LBRC,   M_RBRC,   M_BSLS, \
  ...
  [L_EURKEY_ALTGR] = LAYOUT_60_ansi(
        _______, EU_EXCL, EU_ORDF, EU_ORDM, EU_POUN, EU_EURO, _______, _______, EU_LDQU, EU_LDQU2,EU_RDQU, EU_CHKM, EU_MULT, _______,
        _______, EU_AE,   EU_ARING,EU_EDIA, EU_YACU, EU_THRN, EU_YDIA, EU_UDIA, EU_IDIA, EU_ODIA, EU_OE,   EU_LAQUO,EU_RAQUO, EU_NOT,
        _______, EU_ADIA, EU_SSHP, EU_DSTR, EU_EGRA, EU_EACU, EU_UGRA, EU_UACU, EU_FIKR, EU_OSTR, EU_DEG,  _______,          _______,
        _______,          EU_AGRA, EU_AACU, EU_CCED, EU_IGRA, EU_IACU, EU_NTIL, EU_MU,   EU_OGRA, EU_OACU, EU_IQUE,          _______,
  ...
  [L_EXTENDED] = LAYOUT_60_ansi(
        ...
        C_LCKEXT, MS_BTN4,  MS_WHLU,  MS_BTN5,  ______,   M_TM,     KC_CALC,  KC_HOME,  KC_UP,    KC_END,   ______,   KC_PSCR,  KC_PAUSE, KC_INS, \
        ______,   MS_WHLL,  MS_WHLD,  MS_WHLR,  ______,   ______,   KC_PGUP,  KC_LEFT,  KC_DOWN,  KC_RIGHT, ______,   KC_NUHS,         FN_CONFIG, \
  ...
  [L_CONFIG] = LAYOUT_60_ansi(
        FN_GAME,  DL_ISO,   DL_ANSI,  DL_EURKEY,______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,  QK_BOOT,  \
        RM_TOGG,  RM_NEXT,  UC_WINC,  ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______, \
        ______,   RM_PREV,  DB_TOGG,  ______,   ______,   ______,   ______,   ______,   ______,   UC_LINX,  ______,   ______,          FN_CONFIG, \
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,                       ______, \
        ______,   ______,   ______,                       ______,                                           ______,   ______,   ______,   ______ \
  )
};
