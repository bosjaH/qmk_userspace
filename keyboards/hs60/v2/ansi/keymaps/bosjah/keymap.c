...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_CONFIG] = LAYOUT_60_ansi(
        FN_GAME,  DL_ISO,   DL_ANSI,  DL_EURKEY,______,   ______,   ______,   ______,   ______,   ______,   ______,   BR_DEC,   BR_INC,   QK_BOOT,  \
        ______,   EF_INC,   UC_WINC,  ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______, \
        ______,   EF_DEC,   DB_TOGG,  ______,   ______,   ______,   ______,   ______,   ______,   UC_LINX,  ______,   ______,          FN_CONFIG, \
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,                       ______, \
        ______,   ______,   ______,                       ______,                                           ______,   ______,   ______,   ______ \
  )
};
